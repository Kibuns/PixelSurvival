...
public class FieldOfView : MonoBehaviour
{
	...
	void LateUpdate()
	{
		centerPoint = transform.position + new Vector3(0, viewHeight, 0);
		DrawFieldOfView();
	}
	...
	void FindVisibleTargets()
	{
		...
		Collider[] targetsInViewRadius = Physics.OverlapSphere(centerPoint, viewRadius, targetMask);
		...
		for (int i = 0; i < targetsInViewRadius.Length; i++)
		{
			...
			{
				float dstToTarget = Vector3.Distance(centerPoint, target.position);
